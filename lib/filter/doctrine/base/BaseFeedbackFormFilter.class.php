...
abstract class BaseFeedbackFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_task_creator' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'is_task_creator' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
